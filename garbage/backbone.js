(function (t) {
    ...
    if (typeof define === "function" && define.amd) {
        define(["../scripts/underscore", "jquery", "exports"], function (i, r, s) {
    ...
    var c = function (t, e, i, r, s) {
        t._events = l(f, t._events || {}, e, i, {context: r, ctx: t, listening: s});
        if (s) {
    ...
    h.listenTo = function (t, e, r) {
        ...
        if (!a) {
            ...
            a = n[s] = {obj: t, objId: s, id: o, listeningTo: n, count: 0}
        }
        c(t, e, r, this, a);
        return this
    };
    ...
    h.off = function (t, e, i) {
        ...
        this._events = l(d, this._events, t, e, {context: i, listeners: this._listeners});
        return this
    };
    ...
    var b = {add: true, remove: true, merge: true};
    var x = {add: true, remove: false};
